...
print OUT (";\n");
print OUT ("\n");
print OUT ("extern void* yy_scan_string(const char* str);\n");
print OUT ("extern void yy_delete_buffer(void* buffer);\n");
print OUT ("void $vars{Title}PrepareUI(void){\n");
print OUT ("	void* buf = yy_scan_string(ui_text);\n");
print OUT ("	if(yyparse() != 0){\n");
print OUT ("		yy_delete_buffer(buf);\n");
print OUT ("		return;\n");
print OUT ("	}\n");
print OUT ("	yy_delete_buffer(buf);\n");
print OUT ("}\n");
...
system("byacc -d parser/ui.y") == 0        or die;
system("flex --nounistd parser/ui.l") == 0 or die;
